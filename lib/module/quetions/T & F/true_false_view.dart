...
import 'package:lexus_admin/module/quetions/T%20&%20F/true_false_controller.dart';
import 'package:lexus_admin/styles/styles.dart';
import 'package:lottie/lottie.dart';
import 'package:syncfusion_flutter_datagrid/datagrid.dart';

class TrueOrFalseView extends StatelessWidget {
  TrueOrFalseView({Key? key}) : super(key: key);
  final formKey = GlobalKey<FormState>();
  var controller = Get.isRegistered<TrueFalseController>()
      ? Get.find<TrueFalseController>()
      : Get.put(TrueFalseController());
            ...
            Row(
              children: [
                ...
                ElevatedButton.icon(
                    ...
                    label: const Text('Add True or False')),
                SizedBox(
                  width: Styles.defaultPadding,
                ),
                ElevatedButton.icon(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: SfDataGrid(
                                      ...
                                      source: controller.truefalseDataSource,
                                      columnWidthMode:
...
class addTrueFalse extends StatelessWidget {
  const addTrueFalse(
      {Key? key,
      ...
      : super(key: key);
  final int id;
  final TrueFalseController controller;
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Center(
        child: Text('${id == 0 ? 'Add' : 'Edit'} True or False'),
      ),
      content: SingleChildScrollView(
        child: Padding(
                  ...
                  Obx(() => Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButtonFormField<String>(
                            value: controller.selectedTrueFalse.value,
                            onChanged: (String? newAnswer) {
                              controller.selectedTrueFalse.value = newAnswer!;
                            },
                            items: controller.truefalse
