...
import 'package:lexus_admin/module/quetions/Long/long_controller.dart';
import 'package:lexus_admin/styles/styles.dart';
import 'package:lottie/lottie.dart';
import 'package:syncfusion_flutter_datagrid/datagrid.dart';

class LongView extends StatelessWidget {
  LongView({Key? key}) : super(key: key);
  final formKey = GlobalKey<FormState>();
  var controller = Get.isRegistered<LongController>()
      ? Get.find<LongController>()
      : Get.put(LongController());
            ...
            Row(
              children: [
                ...
                ElevatedButton.icon(
                    ...
                    label: const Text('Add Long Question')),
                SizedBox(
                  width: Styles.defaultPadding,
                ),
                ElevatedButton.icon(
                    onPressed: () {
                      controller.downloadExcel(context,
                          controller.questionModel ?? QuestionModel(), 'long');
                    },
                                  ...
                                  Container(
                                    ...
                                    child: SfDataGrid(
                                      ...
                                      startSwipeActionsBuilder:
                                        ...
                                        return GestureDetector(
                                            onTap: () async {
                                              controller.deleteLong(controller
                                                      .questionModel
                                                      ?.questions?[rowIndex]
                                                      .id ??
                                                  0);
                                      ...
                                      source: controller.longDataSource,
                                      columnWidthMode:
...
class addQuestion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Center(
        child: Text('${id == 0 ? 'Add' : 'Edit'} Long Question'),
      ),
      content: SingleChildScrollView(
        child: Padding(
