class StudentAnalysisModel {
  int? totalUser;
  int? monthlyUsers;
  int? dailyUsers;
  Chart? chart;

  StudentAnalysisModel(
      {this.totalUser, this.monthlyUsers, this.dailyUsers, this.chart});

  StudentAnalysisModel.fromJson(Map<String, dynamic> json) {
